...
const bird = {
    ...
    update: function(){
        // IF THE GAME STATE IS GET READY STATE, THE PUTO PAJARO MUST FLAP SLOWLY
        this.period = state.current == state.getReady ? 10 : 5;
        //WE INCREMEMT THE FRAME BY 1 EACH PERIOD
        this.frame += frames%this.period == 0 ? 1 : 0;
        //FRAME GOES FROM 0 TO 4, THEN WE NEED TO GO BACK TO 0
